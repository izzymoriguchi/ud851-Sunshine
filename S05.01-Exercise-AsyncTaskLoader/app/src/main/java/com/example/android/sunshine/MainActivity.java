...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int SUNSHINE_LOADER = 25;
    ...
    private void loadWeatherData() {
        ...
        Loader<String[]> sunshineLoader = loaderManager.getLoader(SUNSHINE_LOADER);
        if (sunshineLoader == null) {
            loaderManager.initLoader(SUNSHINE_LOADER, bundle, this);
        } else {
            loaderManager.restartLoader(SUNSHINE_LOADER, bundle, this);
        }
    }
